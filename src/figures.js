...
// 启动头部的三行帝企鹅像素图；分段供 Ink 上色，纯文本仍用于计算宽度。
export const MIRO_LOGO_ROWS = [
  [["   ▗█", "#77818d"], ["▀", "yellow"], ["▙", "#77818d"], ["▸", "yellow"]],
  [["  ▟", "#77818d"], ["▌", "yellow"], ["██▐", "#f5f2e9"], ["▙", "#77818d"]],
  [["  ▝", "#77818d"], ["▟", "yellow"], ["██", "#f5f2e9"], ["▙", "yellow"], ["▘", "#77818d"]],
];
export const MIRO_LOGO = MIRO_LOGO_ROWS.map((row) => row.map(([glyphs]) => glyphs).join("")).join("\n");
